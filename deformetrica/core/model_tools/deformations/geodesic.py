...
class Geodesic:
    ...
    def update(self):
        ...
        if self.shoot_is_modified or self.flow_is_modified:
            ...
            if self.forward_extension > 0:
                ...
                self.forward_extension = 0
        print("self.backward_exponential.number_of_time_points", self.backward_exponential.number_of_time_points)
        print("self.forward_exponential.number_of_time_points", self.forward_exponential.number_of_time_points)
        print("self.tmin", self.tmin, "self.tmax", self.tmax, "self.t0", self.t0)
    ...
    def parallel_transport(self, momenta_to_transport_t0, is_orthogonal=False, t1 = 0):
        """
        ...
        #modif fg: t1 : time at which momenta_to_transport_t0 is defined
        """
