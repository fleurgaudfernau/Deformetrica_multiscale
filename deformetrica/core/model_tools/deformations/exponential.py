...
class Exponential:
    ...
    def parallel_transport(self, momenta_to_transport, initial_time_point=0, is_orthogonal=False):
        ...
        """
        print("exp.parallel_transport")
        print("self.number_of_time_points", self.number_of_time_points)
        print("initial_time_point", initial_time_point)
        # Sanity checks ------------------------------------------------------------------------------------------------
