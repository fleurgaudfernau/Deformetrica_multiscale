...
class TruncatedNormalDistribution:
    ...
    def sample(self):
        ...
        for index, mean in np.ndenumerate(self.mean):
            out[index] = truncnorm.rvs((self.a[index] - mean)/self.variance_sqrt, (self.b[index] - mean)/self.variance_sqrt, loc=mean, scale=self.variance_sqrt)
        return out
