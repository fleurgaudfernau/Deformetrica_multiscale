...
class ShootingGrid(FunctionalTest):
    """
    ...
    def test_configuration_4(self):
        self.run_configuration(os.path.abspath(__file__), 'output__4', 'output_saved__4', 'model__4.xml', None, 'optimization_parameters__4.xml', command='compute')
